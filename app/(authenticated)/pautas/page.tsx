...
export default function PautasPage() {
  ...
  // Paginação local
  const totalFilteredPautas = filteredPautas.length
  const totalPages = Math.ceil(totalFilteredPautas / itemsPerPage)
  ...
  useEffect(() => {
    setCurrentPage(1)
  }, [searchTerm, statusFilter, anoFilter])
  ...
  // Estatísticas
  const totalPautas = totalFilteredPautas
            ...
            {totalFilteredPautas === 0 ? (
              ...
              <>
                ...
                <Pagination
                  ...
                  totalItems={totalFilteredPautas}
