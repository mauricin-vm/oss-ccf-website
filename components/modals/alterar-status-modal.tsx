...
const statusOptions = [
  ...
  { value: 'PEDIDO_VISTA', label: 'Pedido de Vista', color: 'bg-orange-100 text-orange-800' },
  { value: 'PEDIDO_DILIGENCIA', label: 'Pedido de Diligência', color: 'bg-red-100 text-red-800' },
